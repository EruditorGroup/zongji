...
const HeartBeat = require('./binlog_event').HeartBeat;
...
function RowsEvent(parser, options, zongji) {
  ...
  if (tableData === undefined) {
    ...
    // Emit fake-heartbeat instead of filtered.
    const fakeHeartBeat = new HeartBeat(parser, options);
    fakeHeartBeat.isFake = true;
    zongji.emit('binlog', fakeHeartBeat);
  } else {
